...
namespace WalleClass
{
    ...
    {
        public Sub(Type exprType, (int, int) location, ExpressionArithmetic leftExpression, ExpressionArithmetic rightExpression) : base(exprType, location, leftExpression, rightExpression)
        {
        }
