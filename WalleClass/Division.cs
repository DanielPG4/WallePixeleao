...
namespace WalleClass
{
    ...
    {
        public Division(Type exprType, (int, int) location, ExpressionArithmetic leftExpression, ExpressionArithmetic rightExpression) : base(exprType, location, leftExpression, rightExpression)
        {
        }
